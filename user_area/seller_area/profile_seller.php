        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <?php
$selectn="SELECT * FROM `add_3ard` WHERE tagr_id='$user_id'";
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          while($rroww=mysqli_fetch_assoc($qun)){
                           $yy_title=$rroww['3ard_title'];
                           $project_id=$rroww['project_id'];
                           $tagr_name=$rroww['tagr_name'];
                           echo"
                           <li><a class='dropdown-item  text-center nav-link' href='project_view.php?project_id=$project_id'>$yy_title,$tagr_name</a></li>
                           "; 
                          }
        ...
        <div class="col-md-2">
            <ul style="height:100vh" class="navbar-nav bg-secondary text-center">
                ...
                <?php
                    ...
                    ?>
                <li class="nav-item ">
                    <a class="nav-link text-light" href="profile_seller.php?projects_view">
                        <h6>مشاريعى</h6>
                    </a>
                </li>
                <li class="nav-item ">
